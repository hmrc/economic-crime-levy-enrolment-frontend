...
class HasEclReferenceFormProviderSpec extends OptionFieldBehaviours {
  val form = new HasEclReferenceFormProvider()()

  "value" should {
    val fieldName   = "value"
    val requiredKey = "hasEclReference.error.required"

    behave like optionsField[TriState](form, fieldName, TriState.values, FormError(fieldName, "error.invalid"))
